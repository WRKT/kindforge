...
To access the cluster services (Ingress) from Windows browsers, you need to update your Windows hosts file.
...
> This allows local domains like `hubble.kindforge-cl01.io` to resolve to `127.0.0.1`.
